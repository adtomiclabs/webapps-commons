package com.adtomiclabs.commons.persistence;

import com.adtomiclabs.commons.exceptions.InvalidPropertiesException;
...
public class PersistenceHelper {
     ...
     */
    public static <T> Predicate toLikePredicate(CriteriaBuilder cb, Root<T> root, String attributeName, String pattern,
                                                MatchMode matchMode, boolean caseSensitive) {
     ...
     */
    public static <T> void validatePageable(Pageable pageable, Class<T> klass) throws InvalidPropertiesException {
